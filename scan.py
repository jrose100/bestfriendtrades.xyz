...
Uses Tiingo EOD API (free plan compatible).
"""

import json, os, time, requests
from datetime import datetime, timezone, timedelta

TIINGO_TOKEN = os.environ.get("TIINGO_TOKEN", "817c55eb310cb405f7db1124213489aa90e59b75")
...
def fetch_bars(ticker):
    ...
    # Tiingo returns oldest-first already
    return data
...
def main():
    ...
    print(f"Scanning {len(tickers)} tickers via Tiingo EOD...")
    results = []
    errors  = []
